...
class FormulasControllerTest < ActionController::TestCase
  ...
  test "should create formula" do
    assert_difference('Formula.count') do
      post :create, formula: { descripcion: @formula.descripcion, nombre: @formula.nombre, tiempo: @formula.tiempo, tipo: @formula.tipo }
    end
  ...
  test "should update formula" do
    put :update, id: @formula, formula: { descripcion: @formula.descripcion, nombre: @formula.nombre, tiempo: @formula.tiempo, tipo: @formula.tipo }
    assert_redirected_to formula_path(assigns(:formula))
  end
